...
/***/ function(module, exports, __webpack_require__) {
	...
	var _weiboList = __webpack_require__(2);

	var _weiboList2 = _interopRequireDefault(_weiboList);

	var _weiboUser = __webpack_require__(8);

	var _weiboUser2 = _interopRequireDefault(_weiboUser);

	var _weiboPiece = __webpack_require__(9);

	var _weiboPiece2 = _interopRequireDefault(_weiboPiece);
	    ...
	    if (host === 'm.weibo.cn') {
	        ...
	        switch (type) {
	            case 'WEIBOUSER':
	                ...
	                break;
	            case 'WEIBOCONTENT':
	                var weiboPiece = new _weiboPiece2.default();
	                break;
	            case 'WEIBOLIST':
	                var weiboList = new _weiboList2.default();
	                break;
	            case 'WEIBOVIEWS':
	                ;
	                break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _weibo = __webpack_require__(5);
	...
	var WeiboList = function (_Weibo) {
	    ...
	    function WeiboList() {
	        ...
	        _this.speed = 6000; //爬去速度
	        _this.pageCount = 10;
	        //获取地址
	        _this.getUrl = "http://m.weibo.cn/page/json";
	        //传递地址
	        _this.postUrl = "http://127.0.0.1:3000/weibo/lists";
	        //请求参数
	        ...
	        _this.methods = {
	            ...
	            "click #set": function clickSet(event) {
	                ...
	                var speed = (0, _jquery2.default)("#scrapy-wrapper-weibo #speed").val();
	                speed = parseInt(speed) * 1000;
	                var position = (0, _jquery2.default)("#scrapy-wrapper-weibo #position").val();
	                position = parseInt(position);
	                //设置请求开始页数
	                var page = position ? Math.floor(position / 10) : 1;
	                _this.params.page = page;
	                _this.setOption(speed, position);
	            },
	    ...
	    _createClass(WeiboList, [{
	        ...
	        value: function getUserUid() {
	            this.user.uid = (0, _jquery2.default)(".card-list .mod-media:first").attr("href").split("/")[2];
	        }
	    }, {
	        key: 'doGet',
	        value: function doGet() {
	            ...
	            this.getData(this.getUrl, this.params, function (data) {
	                ...
	                if (_this2.params.page == 1) {
	                    ...
	                    _this2.allTime = _this2.total * _this2.speed / 10; //采集时间//每次10条
	                }
	                ...
	                if (data.cards[0].mod_type == "mod/pagelist" && data.count != "") {
	                    ...
	                    var lists = {
	                        uid: _this2.user.uid,
	                        lists: postParams,
	                        currentPage: _this2.params.page
	                    };
	                    ...
	                    _this2.postData(_this2.postUrl, lists, function (data) {
	                        if (data.state) {
	                            ...
	                            if (data.allreadyUpdate) {
	                                clearInterval(_this2.timeHandle);
	                                _this2.upDateUI();
	                                return;
	                            }

	                            _this2.hasCollect = data.collectNum;
	                            _this2.user.missing = data.missing;
	                            _this2.lessTime = (_this2.total - _this2.pageCount * tempPage) * _this2.speed / 10;

	                            if (_this2.lessTime < 0) {
	                                _this2.lessTime = 0;
	                            }
	                    ...
	                    _this2.params.page = _this2.params.page;
	                }
	            });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	* */
	...
	var _weiboCommon = __webpack_require__(6);
	...
	var Weibo = function () {
	    ...
	    _createClass(Weibo, [{
	        ...
	        value: function upDateUI() {
	            ...
	            (0, _jquery2.default)("#scrapy-wrapper-weibo").html(updateHtml);
	        }
	    }, {
	        key: 'bindEvents',
	        value: function bindEvents(methods) {
	            _lodash2.default.each(methods, function (func, key) {
	                ...
	                var dom = key.split(" ")[1];
	                (0, _jquery2.default)("#scrapy-wrapper-weibo").delegate(dom, event, func);
	            });
	        }
	    }, {
	        key: 'checkHasCreate',
	        value: function checkHasCreate() {
	            ...
	            (0, _weiboCommon.checkExistUser)(this.user.uid).done(function (data) {
	                if (data.state) {
	                    _this.created = true;
	                    _this.user.missing = data.missing;
	                    _this.hasCollect = data.hasCollect;
	                    _this.total = data.total;
	                    _this.totalPage = Math.floor(data.total / 10);
	                    _this.upDateUI();
	                } else {
	                    _this.upDateUI();
	                }
	        ...
	        key: 'setOption',
	        value: function setOption(speed, position) {
	        ...
	        key: 'getData',
	        value: function getData(url, params, success) {
	        ...
	        key: 'postData',
	        value: function postData(url, params, success) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.checkExistWeibo = checkExistWeibo;
	exports.createWeibo = createWeibo;
	...
	function checkExistWeibo(uid, bid) {
	    return _jquery2.default.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeiboPiece = function () {
	    function WeiboPiece() {
	        var _this = this;

	        _classCallCheck(this, WeiboPiece);
	        ...
	        this.createWeiboEvents = {
	            "click .create-weibo button": function clickCreateWeiboButton(event) {
	                /*
	                *
	                ...
	                * */
	                ...
	                (0, _weiboCommon.createWeibo)(data, user.uid);
	                console.log(data);
	            }
	        };

	        (0, _weiboCommon.checkExistUser)(user.uid).then(function (data) {

	            if (data.state) {
	                //用户已经创建
	                _this.createUser = true;
	                (0, _weiboCommon.checkExistWeibo)(user.uid, weibo.bid).done(function (data) {
	                    if (data.state) {
	                        //可以继续采集数据
	                        _this.createWeibo = true;
	                        _this.weibo = data.data;
	                        _this.scrapyUI();
	                    } else {
	                        //先要创建该微博

	                        _this.gotoCreateWeibo();
	                    }
	                });
	            } else {
	                //显示让用户去创建该用户账号
	                _this.goToCreateUser(user.uid);
	            }
	        });
	    }

	    _createClass(WeiboPiece, [{
	        key: 'scrapyUI',
	        value: function scrapyUI() {
	            ...
	            (0, _jquery2.default)(this.dom).find("#scrapy-wrapper-weibo").remove();
	            (0, _jquery2.default)(this.dom).append(scrapyUI);
	            this.bindEvents(this.methods);
	        }
	    }, {
	        key: 'goToCreateUser',
	        value: function goToCreateUser(uid) {
	            var createUserhtml = '     <span id="scrapy-wrapper-weibo">\n                <div id="scrapy-weibo" class="scrapy-weibo  weibo-piece ' + (this.hideState ? "" : "showItem") + '">\n                <div class="wrap">\n                        <h1>未创建该用户</h1>\n                        <div class="create-user">\n                        <a href="http://m.weibo.cn/u/' + uid + '">GO创建该用户</a>\n                        </div>\n                        </div>\n                </div>       \n                 </span>\n            ';
	            (0, _jquery2.default)(this.dom).find("#scrapy-wrapper-weibo").remove();
	            (0, _jquery2.default)(this.dom).append(createUserhtml);
	            this.bindEvents(this.methods);
	        }
	    }, {
	        key: 'gotoCreateWeibo',
	        value: function gotoCreateWeibo() {
	            var createWeibohtml = '     <span id="scrapy-wrapper-weibo">\n                <div id="scrapy-weibo" class="scrapy-weibo  weibo-piece ' + (this.hideState ? "" : "showItem") + '">\n                <div class="wrap">\n                        <h1>未创建该条微博</h1>\n                        <div class="create-weibo">\n                        <button >创建该条微博</button>\n                        </div>\n                </div>  \n                     </div>\n                 </span>\n            ';
	            (0, _jquery2.default)(this.dom).find("#scrapy-wrapper-weibo").remove();
	            (0, _jquery2.default)(this.dom).append(createWeibohtml);
	            this.bindEvents(this.methods);
	            this.bindEvents(this.createWeiboEvents);
	        }
	    }, {
	        key: 'parseWeibo',
	        value: function parseWeibo() {
